        ...
        <el-form
            ...
            <input id="kehuId" name="kehuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="订单备注" prop="wuziOrderContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.wuziOrderContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.wuziOrderContent" label="订单备注" prop="wuziOrderContent">
                            <span v-html="ruleForm.wuziOrderContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
