               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预警值" prop="yujingNumber">
                       <el-input v-model="ruleForm.yujingNumber"
                                 placeholder="预警值" clearable  :readonly="ro.yujingNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="物资简介" prop="wuziContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.wuziContent" label="物资简介" prop="wuziContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   wuziContent: [
                              { required: true, message: '物资简介不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
